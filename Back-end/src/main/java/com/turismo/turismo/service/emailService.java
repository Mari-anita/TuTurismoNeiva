    ...
    public String enviarCorreoSolicitudEmpresa(String destinatario){
        try{
            ...
            + "<p style=\"font-size: 16px; margin-bottom: 20px;\">\n" + //
                                ...
                                "\n" + //
                                "TuTurismo Neiva le agradece por ponerse en contacto con nosotros. Quería informarle que hemos recibido su solicitud y estamos en proceso de revisar la información que nos proporcionó.\n" + //
                                "\n" + //
                                "Una vez que hayamos revisado todo detenidamente, le enviaremos un correo con nuestra respuesta.\n" + //
                                "\n" + //
                                "Agradecemos su paciencia y comprensión. Si tiene alguna pregunta adicional mientras tanto, no dude en ponerse en contacto con nosotros.\n" + //
                                "\n" + //
                                "Gracias por unirte a nosotros. No olvides seguirnos en nuestras redes sociales. </p>\r\n" 
            + "<br>TuTurismo Neiva\r\n" 
            + "</div>\r\n" 
            + "<div class=\"footer\" style=\"background-color: #333; color: #fff; padding: 10px; text-align: center; margin-top: 20px;\">\r\n" 
            + "<a href=\"#\" style=\"color: #fff; text-decoration: none; margin: 0 10px;\">Términos y condiciones</a> | <a href=\"#\" style=\"color: #fff; text-decoration: none; margin: 0 10px;\">Política de privacidad</a>\r\n" 
