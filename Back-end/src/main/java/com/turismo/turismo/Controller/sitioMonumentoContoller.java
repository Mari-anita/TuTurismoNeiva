...
public class sitioMonumentoContoller {
    ...
    public ResponseEntity<Object> save(SitioMonumento SitioMonumento, @RequestParam("file") MultipartFile file)
        ...
        // if (SitioMonumento.getFechaCreacionSitioMonumento() == null ||
        // SitioMonumento.getFechaCreacionSitioMonumento() < new Date() ) {
        // return new ResponseEntity<>("Este campo es obligatorio",
    ...
    public ResponseEntity<Object> guardarImagenJson(SitioMonumento SitioMonumento,
        ...
        try {
            ...
            if (resultado == 0) {
                ...
                return new ResponseEntity<>(new respuestaSitio("error", "Error al guardar"),
